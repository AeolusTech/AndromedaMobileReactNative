...
const ChatList = () => {
    const chats = [
        { name: 'John', lastMessageTime: '10:30 AM', profilePic: require('../assets/pictures/man-0.png') },
        { name: 'Jane', lastMessageTime: 'Yesterday', profilePic: require('../assets/pictures/woman-0.png') },
      ];
                ...
                <TouchableOpacity onPress={() => goToChat(chat.name, chat.profilePic)}>
                    <View key={index} style={styles.chatBox}>
                        <View style={styles.profilePic}>
                            <Image style={styles.image} source={chat.profilePic} />
                        </View>
